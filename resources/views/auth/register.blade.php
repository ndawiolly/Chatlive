...
<div class="container-fluid cover">
    <div class="row justify-content-center" id="login_page">
        <div class="col-md-8">
            <div class="card bg-transparent border border-info shadow">
                <div class="card-header text-light fw-bolder fs-3">{{ __('Register') }}</div>
